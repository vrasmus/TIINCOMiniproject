...
% trellisCodeLabels = [string('$C_{2}(3,1,3)$'),string('$C_{6}(3,1,6)$'),string('$C_{7}(3,1,2)$')];
...
% trellisCodeLabels = [string('$C_{3}(4,1,2)$'),string('$C_{8}(4,1,6)$'),string('$C_{9}(4,1,3)$')];

%% Constant constaint lenght (3), different code rates
% trellisList = [trellis3,trellis5,trellis7];
% trellisCodeLabels = [string('$C_{3}(4,1,2)$'),string('$C_{5}(2,1,2)$'),string('$C_{7}(3,1,2)$')];
...
% trellisCodeLabels = [string('$C_{1}(2,1,6)$'),string('$C_{6}(3,1,6)$'),string('$C_{8}(4,1,6)$')];
